 ...
 * @author Juanma
 */
public class Elegir_Numero extends javax.swing.JFrame {
    static Objeto_Instanciar objeto_usuario;
    /**
     * Creates new form Elegir_Numero
     */
    public Elegir_Numero() {
        initComponents();
        actualizarJTabale();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Elegir_Numero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Elegir_Numero().setVisible(true);
            }
        });
    }
