 ...
 * @author Juanma
 */
public class Elegir_Numero_Barra extends javax.swing.JFrame {
    static Objeto_Instanciar objeto_usuario;
    /**
     * Creates new form Elegir_Numero
     */
    public Elegir_Numero_Barra() {
        initComponents();
        actualizarJTabale();
    ...
    public void actualizarJTabale(){
        //tiene que conectarse para poder ver las mesas
        objeto_usuario.obtener_datos_conecion_interfaz_usuario("administrador", "1234");
         
        //String consulta = "select table_name from user_tables"; 
        String consulta = "SELECT CODIGO_MESA FROM BAR_RESTAURANTE.MESAS WHERE ESTADO=0";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Cliente_Barra cliente = new Cliente_Barra();
        String nombre_mesa=jComboBox1.getSelectedItem().toString();
        cliente.setVisible(true);
        cliente.numero_mesa_cliente(nombre_mesa);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Elegir_Numero_Barra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Elegir_Numero_Barra().setVisible(true);
            }
        });
    }
