...
public class Factura extends javax.swing.JFrame {
    ...
    public Factura() {
        ...
        setResizable(false);
        //codigo para ajustar una imagen
        ImageIcon imagen = new ImageIcon(getClass().getResource("/Imagnes/Restaurante.jpg"));
        ...
        jLabel23.setText(formateador.format(ahora));
    ...
    public void mostrar_datos_cliente(String cedula_cliente){
        System.out.println("*******************************");
        String consulta = "SELECT * FROM BAR_RESTAURANTE.PERSONAS WHERE CEDULA='"+cedula_cliente+"'";
        System.out.println("*******************************");
        try{  
            ...
            while (resultSet.next()){
                ...
                for (int i=0;i<numeroDeCampos;i++){//sirve para el objeto mirReglo carge con cada columna del obejto de resultSet
                    ...
                    System.out.println("Datos cleinte "+miReglon[i].toString()+i);
                }
                jTextField3.setText(miReglon[0].toString());
                jTextField1.setText(miReglon[1].toString());
                jTextField6.setText(miReglon[2].toString());
                jTextField7.setText(miReglon[3].toString());
    ...
    public void validar_textFiel_NoVacio(){
        if(jTextField3.getText().length()==0){
            JOptionPane.showMessageDialog(rootPane, "Tiene que ingresara la cedula del cliente...");
        }
        else if(jTextField1.getText().length()==0){
            JOptionPane.showMessageDialog(rootPane, "Tiene que ingresara el nombre del cliente....");
        }
        else if(jTextField7.getText().length()==0){
            JOptionPane.showMessageDialog(rootPane, "Tiene que ingresarar el Direccion del cliente....");
        }
        else if(jTextField6.getText().length()==0){
            JOptionPane.showMessageDialog(rootPane, "Tiene que ingresarar el telefono del cliente....");
        }
        else {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave del Producto", "Nombre", "Cantidad", "Descripcion", "IVA", "Precio"
            }
        ));
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagnes/Restaurante.jpg"))); // NOI18N
        ...
        jLabel21.setText("0123456789");

        jLabel22.setText("jLabel22");

        jLabel14.setText("Direccion:");

        jLabel15.setText("Avenida Gil RAmires Daavalos");

        jLabel16.setText("Telefono:");

        jLabel17.setText("090825216252637");
        ...
        jButton4.setText("Verificar Cliente");
        ...
        jLabel26.setText("Firma Cliente");

        jLabel27.setText("Firma Cajero");

        jLabel28.setText("__________________");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String cedula_cliente= jTextField3.getText();
        
        mostrar_datos_cliente(cedula_cliente);
